...
<%@ include file="../../fragments/sidebar.jsp" %>
        ...
        <hr>
        <div>
        	<form:form class="user-add-form" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/users/create/new/teacher" modelAttribute="teacher">
