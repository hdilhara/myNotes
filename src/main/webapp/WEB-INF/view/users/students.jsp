<%@page import="com.hdilhara.edu.entity.Student"%>
...
<!-- start of content  -->
  ...
  <path fill-rule="evenodd" d="M13 14s1 0 1-1-1-4-6-4-6 3-6 4 1 1 1 1h10zm-9.995-.944v-.002.002zM3.022 13h9.956a.274.274 0 0 0 .014-.002l.008-.002c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664a1.05 1.05 0 0 0 .022.004zm9.974.056v-.002.002zM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
      ...
      <hr>
       ...
       <a  href="${pageContext.request.contextPath}/users/add/student"><button class="btn btn-outline-dark std-manage-btn"  > ADD NEW STUDENT</button></a>
       <br>
          &nbsp;&nbsp; CLASS &nbsp;&nbsp;&nbsp;
            <select >
              <option>1</option>
        ...
        <div class="student-load-results">
          ...
          <div class="card student-load-result" style="width: 175px;">
            ...
            <img src="data:image/png;base64, ${student.stringProfilePicture}"  class="card-img-top" alt="...">
            
            <div class="card-body">
              <p class="card-text loaded-student-details">
                <b>${student.firstName}</b><br>
                ${student.lastName}<br>
                ${student.dob}<br>
                section
              </p>
